...
#     QML_IMPORT_PATH = "${pkgs.qt6.qt5compat}/lib/qt-6/qml:${pkgs.qt6.qtbase}/lib/qt-6/qml:${pkgs.kdePackages.kirigami}/lib/qt-6/qml";
#     QML2_IMPORT_PATH = "${pkgs.qt6.qt5compat}/lib/qt-6/qml:${pkgs.qt6.qtbase}/lib/qt-6/qml:${pkgs.kdePackages.kirigami}/lib/qt-6/qml";
#   };
    environment.variables = {
