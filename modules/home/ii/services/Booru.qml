...
Singleton {
    ...
    property var providers: {
        ...
        //     "api": "&api_key=d05e30a68bec612c4a67ea77c4edd09490abc25091f447348a809e6383ba64b73117e629e3c4ef22d1e85dbada97605a7ca73862c83f0ab2ef5993333bb46ec4&user_id=2029155",
        ...
        "gelbooru": {
            ...
            "description": Translation.tr("Rule34 | Huge database"),
            ...
            "mapFunc": (response) => {
                return response.map(item => {
                    return {
                        ...
                        "file_url": item.file_url,
                        "file_ext": item.file_url.split('.').pop(),
                                    "source": item.source ?? item.file_url,
                    }
                })
            },

            "tagSearchTemplate":
            "https://api.rule34.xxx/index.php?page=dapi&s=tag&q=index&json=1&limit=10&name_pattern={{query}}%&api_key=93fdde342e6cf5a5dae5303e27acdfc513eff57cbd22bf1860dfab5133e0d5e616bee02ab192c09be70f195683258ea3c155029bd435b05ba1e6d6743a68b387&user_id=6133174",

            "tagMapFunc": (response) => {
                let tags = response.tag ?? response
    ...
    function constructRequestUrl(tags, nsfw=true, limit=20, page=1) {
        ...
        if (!nsfw && currentProvider != "gelbooru" && !(["zerochan", "waifu.im", "t.alcy.cc"].includes(currentProvider))) {
        ...
        if (currentProvider === "zerochan") {
            ...
            if (currentProvider == "gelbooru") {
                ...
                params.push("api_key=93fdde342e6cf5a5dae5303e27acdfc513eff57cbd22bf1860dfab5133e0d5e616bee02ab192c09be70f195683258ea3c155029bd435b05ba1e6d6743a68b387")
                params.push("user_id=6133174")
            }
            else {
                params.push("tags=" + encodeURIComponent(tagString))
                params.push("limit=" + limit)
